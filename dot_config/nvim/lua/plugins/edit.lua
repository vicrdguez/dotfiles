...
return {
    {
        ...
        keys = {
            --   -- mode defaults to "n"
            --   -- special
            { "<leader><space>", telescope("buffers", { show_all_buffers = true }), desc = "Switch buffer" },
            { "<leader>.", telescope("find_files"), desc = "Find files (root dir)" },
            { "<leader>/", telescope("current_buffer_fuzzy_find", { previewer = false }), desc = "Search in buffer" },
            { "<leader>;", telescope("commands"), desc = "Search commands" },
            --   { "<leader>:", "<cmd>Telescope command_history<cr>", desc = "Command History" },
            --   { "<leader>?", telescope("keymaps"), desc = "Seach keymap" },
            --
            --   -- files/find
            { "<leader>ff", telescope("find_files", { cwd = false }), desc = "Find files (cwd)" },
            { "<leader>fr", telescope("old_files"), desc = "Find recent files" },
            { "<leader>fg", telescope("git_files"), desc = "Find git files" },
            --
            --   -- search
            { "<leader>sg", telescope("live_grep", { cwd = false }), desc = "Search in files (cwd)" },
            { "<leader>sG", telescope("live_grep"), desc = "Search in files (root dir)" },
            { "<leader>sh", telescope("help_tags"), desc = "Search help pages" },
            --   {
            --     "<leader>sc",
