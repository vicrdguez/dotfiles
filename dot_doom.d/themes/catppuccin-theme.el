...
(let ((colors '((undef     "#ff00ff" "#ff00ff")
      ...
      (faces '(;; default / basic faces
               ...
               (org-code :foreground ,ctp-maroon) ;; vic: changed from  `cpt-green'
               ...
               (org-hide :foreground ,ctp-base :background ,ctp-base) ;; vic: modified fg from ctp-crust
               ...
               (org-quote :inherit markdown-blockquote-face :slant italic) ;vic: added italics
               ...
               (org-verbatim :inherit markdown-blockquote-face :foreground ,ctp-green) ;vic: changed from inheriting `org-quote'
